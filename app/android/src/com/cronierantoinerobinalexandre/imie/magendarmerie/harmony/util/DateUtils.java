/**************************************************************************
 * DateUtils.java, magendarmerie Android
 *
 * Copyright 2014
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.cronierantoinerobinalexandre.imie.magendarmerie.harmony.util;
...
public class DateUtils extends android.text.format.DateUtils {
	...
	public static String formatDateToString(DateTime date, boolean local) {
		java.text.DateFormat df = MagendarmerieApplication.getDateFormat();
	...
	public static String formatTimeToString(DateTime time) {
		String result = null;
		if (MagendarmerieApplication.is24Hour()) {
	...
	public static DateTime formatStringToDate(String date) {
		return formatStringToDateTime(MagendarmerieApplication
							.getDateFormat(), date);
	}
